package com.content_load_sb.persistmysqlslave.entity;
...
public class TargetFileSlave extends BaseEntity {
    @Column(name = "PATH")
    private String path;
    ...
    private TargetDirectorySlave directory;
    ...
    public TargetDirectorySlave getDirectory() {
        return directory;
    }

    public void setDirectory(TargetDirectorySlave directory) {
