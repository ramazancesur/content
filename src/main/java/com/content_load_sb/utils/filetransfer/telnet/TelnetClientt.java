package com.content_load_sb.utils.filetransfer.telnet;
 ...
 */
public class TelnetClientt implements Runnable, TelnetNotificationHandler {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (true) {
            ...
            try {
                ...
                Thread reader = new Thread(new TelnetClientt());
                tc.registerNotifHandler(new TelnetClientt());
